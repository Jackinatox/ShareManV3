...
namespace ShareManV3.databaseSelfMade
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(MyCurrency),
            typeof(Div_Intervall),
            typeof(StockExchange),
            typeof(Stock_type),
            typeof(Share),
            typeof(Stock_Price_History)
        };
        ...
        public static string ConnectionString { get { return System.Configuration.ConfigurationManager.ConnectionStrings["databaseSelfMade"].ConnectionString; } }
